...
win32 {
    ...
    LIBS += -lssl -lcrypto -lcurl $$system(curl-config --static-libs) -ldb_cxx$$BDB_LIB_SUFFIX
...
!win32 {
    ...
    genleveldb.commands = cd $$PWD/src/leveldb && CC=$$QMAKE_CC CXX=$$QMAKE_CXX AR=$$QMAKE_AR $(MAKE) OPT=\"$$QMAKE_CXXFLAGS $$QMAKE_CXXFLAGS_RELEASE\" out-static/libleveldb.a out-static/libmemenv.a
} else {
...
windows:DEFINES += __STDC_FORMAT_MACROS
windows:DEFINES += CURL_STATICLIB
...
macx:ICON = src/qt/res/icons/swipp.icns
macx:TARGET = "Swipp-Qt"
...
LIBS += -lssl -lcrypto -lcurl -ldb_cxx$$BDB_LIB_SUFFIX
