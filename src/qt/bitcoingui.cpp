    ...
    nWeight(0)
{
    //resize(970, 570);
	resize(1080, 662);
    setWindowTitle(tr("Swipp") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("Swipp");
    setStyleSheet("#Swipp { background-color: #f9f9f9);  }"
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Swipp address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&SwippNodes"), this);
    masternodeManagerAction->setToolTip(tr("Show SwippNodes Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About Swipp"), this);
    aboutAction->setToolTip(tr("Show information about Swipp"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Swipp"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Swipp client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Swipp client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Swipp network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Swipp address or malformed URI parameters."));
    }
