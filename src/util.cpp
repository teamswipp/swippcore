...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Swipp
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Swipp
    // Mac: ~/Library/Application Support/Swipp
    // Unix: ~/.swipp
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Swipp";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "swipp.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "swippd.pid"));
