...
Value validatepubkey(const Array& params, bool fHelp)
{
    if (fHelp || !params.size() || params.size() > 2)
        throw runtime_error("validatepubkey <Swipppubkey>\n"
                            "Return information about <Swipppubkey>.");
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error("verifymessage <Swippaddress> <signature> <message>\n"
...
Value spork(const Array& params, bool fHelp)
{
    ...
    throw runtime_error("spork <name> [<value>]\n"
                        ...
                        "<value> is a epoch datetime to enable or disable spork" + HelpRequiringPassphrase());
}
