...
template<typename T1, typename T2> inline uint256 Hash(const T1 p1begin, const T1 p1end,
...
template<typename T1, typename T2, typename T3> inline uint256 Hash(const T1 p1begin, const T1 p1end, const T2 p2begin,
